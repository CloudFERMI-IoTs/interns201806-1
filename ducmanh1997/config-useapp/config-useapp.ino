...
void setup() {
  Serial.begin(115200);
  pinMode(32, OUTPUT); 
  /* đặt ESP32 sang chế độ Station (Để chạy SmartConfig nó phải được đặt ở chế độ Station) */
  WiFi.mode(WIFI_AP_STA);
  /* khởi động SmartConfig */
  WiFi.beginSmartConfig();

  /* Đợi gói SmartConfig từ điện thoại di động */
